...
const AuthFormWidget: FC<Props> = ({children}) => {
  ...
  return <BaseForm onSubmitForm={handleSubmit(submitAuthForm)} titleForm={'Войти'}>
    <Stack gap={4}>
        <Stack>
          <Text fontSize={14}>Логин или E-mail</Text>
          <Input {...register('login_or_email')} placeholder='Введите ваш логин или E-mail' />
        </Stack>
        <Stack>
      ...
      <Button mt={8} type={'submit'}>Войти</Button>
  </BaseForm>;
};
